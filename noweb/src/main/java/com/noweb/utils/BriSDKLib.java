...
public class BriSDKLib {
    ...
    // nMaxCount
    public static String QNVDLLNAME = "C:\\ICC301lib\\qnviccub.dll";
    ...
    public static int QNV_OpenDevice(int uDevType, int uValue, String strValue) {
        ...
        try {
            ...
            System.load("C:\\ICC301lib\\qnviccub.dll");


            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_OpenDevice");
    ...
    public static int QNV_CloseDevice(int uDevType, int uValue) {
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_CloseDevice");
    ...
    public static int QNV_SetDevCtrl(int nChannelID, int uCtrlType, int nValue) {
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_SetDevCtrl");
            jnative.setRetVal(Type.INT);
            int i = 0;
    ...
    public static int QNV_GetDevCtrl(int nChannelID, int uCtrlType) {
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_GetDevCtrl");
            jnative.setRetVal(Type.INT);
            int i = 0;
            jnative.setParameter(i++, Type.INT, String.valueOf(nChannelID));
            jnative.setParameter(i++, Type.INT, String.valueOf(uCtrlType));
    ...
    public static int QNV_SetParam(int nChannelID, int uParamType, int nValue) {
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_SetParam");
            jnative.setRetVal(Type.INT);
            int i = 0;
            jnative.setParameter(i++, Type.INT, String.valueOf(nChannelID));
    ...
    public static int QNV_GetParam(int nChannelID, int uParamType) {
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_GetParam");
            jnative.setRetVal(Type.INT);
            int i = 0;
            jnative.setParameter(i++, Type.INT, String.valueOf(nChannelID));
            jnative.setParameter(i++, Type.INT, String.valueOf(uParamType));
    ...
    public static int QNV_PlayFile(int nChannelID, int uPlayType, int nValue,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_PlayFile");
            jnative.setRetVal(Type.INT);
            int i = 0;
            jnative.setParameter(i++, Type.INT, String.valueOf(nChannelID));
    ...
    public static int QNV_PlayBuf(int nChannelID, int uPlayType, int nValue,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_PlayBuf");
            jnative.setRetVal(Type.INT);
            int i = 0;
            jnative.setParameter(i++, Type.INT, String.valueOf(nChannelID));
            jnative.setParameter(i++, Type.INT, String.valueOf(uPlayType));
    ...
    public static int QNV_PlayMultiFile(int nChannelID, int uPlayType,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_PlayMultiFile");
            jnative.setRetVal(Type.INT);
            int i = 0;
            jnative.setParameter(i++, Type.INT, String.valueOf(nChannelID));
            jnative.setParameter(i++, Type.INT, String.valueOf(uPlayType));
    ...
    public static int QNV_PlayString(short nChannelID, int uPlayType,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_PlayString");
            jnative.setRetVal(Type.INT);
            int i = 0;
            jnative.setParameter(i++, Type.INT, String.valueOf(nChannelID));
            jnative.setParameter(i++, Type.INT, String.valueOf(uPlayType));
    ...
    public static int QNV_RecordFile(int nChannelID, int uRecordType,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_RecordFile");
            jnative.setRetVal(Type.INT);
            int i = 0;
            jnative.setParameter(i++, Type.INT, String.valueOf(nChannelID));
    ...
    public static int QNV_RecordBuf(int nChannelID, int uRecordType,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_RecordBuf");
            jnative.setRetVal(Type.INT);
            int i = 0;
            jnative.setParameter(i++, Type.INT, String.valueOf(nChannelID));
            jnative.setParameter(i++, Type.INT, String.valueOf(uRecordType));
    ...
    public static int QNV_Conference(int nChannelID, int nConfID,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_Conference");
            jnative.setRetVal(Type.INT);
            int i = 0;
            jnative.setParameter(i++, Type.INT, String.valueOf(nChannelID));
    ...
    public static int QNV_Broadcast(int nChannelID, int uBroadType, int nValue,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_Broadcast");
            jnative.setRetVal(Type.INT);
            int i = 0;
            jnative.setParameter(i++, Type.INT, String.valueOf(nChannelID));
    ...
    public static int QNV_Speech(int nChannelID, int uSpeechType, int nValue,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_Speech");
            jnative.setRetVal(Type.INT);
            int i = 0;
            jnative.setParameter(i++, Type.INT, String.valueOf(nChannelID));
    ...
    public static int QNV_Fax(int nChannelID, int uFaxType, int nValue,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_Fax");
            jnative.setRetVal(Type.INT);
            int i = 0;
            jnative.setParameter(i++, Type.INT, String.valueOf(nChannelID));
    ...
    public static int QNV_Event(int nChannelID, int uEventType, int nValue,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_Event");
            jnative.setRetVal(Type.INT);
            int i = 0;
            jnative.setParameter(i++, Type.INT, String.valueOf(nChannelID));
     ...
     * iRet = -1; if (uEventTy
     * System.load("01lib\\qnviccub.dll", "QNV_");pe == QNV_EVENT_POP) { return -1; } try { JNative
     * jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_Event");
    ...
    public static int QNV_General(int nChannelID, int uGeneralType, int nValue,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_General");
            jnative.setRetVal(Type.INT);
            int i = 0;
            jnative.setParameter(i++, Type.INT, String.valueOf(nChannelID));
    ...
    public static int QNV_CallLog(short nChannelID, int uLogType,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_CallLog");
            jnative.setRetVal(Type.INT);
            int i = 0;
            jnative.setParameter(i++, Type.INT, String.valueOf(nChannelID));
    ...
    public static int QNV_DevInfo(int nChannelID, int uDevInfoType) {
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_DevInfo");
            jnative.setRetVal(Type.INT);
            int i = 0;
            jnative.setParameter(i++, Type.INT, String.valueOf(nChannelID));
    ...
    public static int QNV_Tool(int uToolType, int nValue, String pInValue,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_Tool");
            jnative.setRetVal(Type.INT);
            int i = 0;
    ...
    public static int QNV_Storage(int uDevID, int nOPType, int nSeek,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_Storage");
            jnative.setRetVal(Type.INT);
            int i = 0;
    ...
    public static int QNV_Remote(int uRemoteType, int nValue, String pInValue,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_Remote");
            jnative.setRetVal(Type.INT);
            int i = 0;
    ...
    public static int QNV_CCCtrl(int uCtrlType, String pInValue, int nValue) {
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_CCCtrl");
            jnative.setRetVal(Type.INT);
            int i = 0;
            jnative.setParameter(i++, Type.INT, String.valueOf(uCtrlType));
            if (pInValue == null || pInValue.isEmpty()
    ...
    public static int QNV_CCCtrl_Call(int uCallType, int lSessHandle,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_CCCtrl_Call");
            jnative.setRetVal(Type.INT);
            int i = 0;
    ...
    public static int QNV_CCCtrl_Msg(int uMsgType, String pDestCC,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_CCCtrl_Msg");
            jnative.setRetVal(Type.INT);
            int i = 0;
    ...
    public static int QNV_CCCtrl_Contact(int uContactType, String pDestCC,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_CCCtrl_Contact");
            jnative.setRetVal(Type.INT);
            int i = 0;
    ...
    public static int QNV_CCCtrl_CCInfo(int uInfoType, String pDestCC,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_CCCtrl_CCInfo");
            jnative.setRetVal(Type.INT);
            int i = 0;
    ...
    public static int QNV_Socket_Client(int uSktType, int nHandle, int nValue,
        ...
        try {
            System.load("C:\\ICC301lib\\qnviccub.dll");
            JNative jnative = new JNative("C:\\ICC301lib\\qnviccub.dll", "QNV_Socket_Client");
            jnative.setRetVal(Type.INT);
            int i = 0;
