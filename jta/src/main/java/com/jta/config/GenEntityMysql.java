 ...
 * @Vsersion: 1.0
 * <p>
 * Created by casia.wangzhiyou on 2021/01/28
 * Email: zhiyou_wang@foxmail.com
 */
public class GenEntityMysql {
    private String ent_packageOutPath = "main.java.com.jta.entity.mysql.test1.tab";//指定实体生成所在包的路径
    private String jpa_packageOutPath = "main.java.com.jta.entity.mysql.test1.rep";//指定实体jpa生成所在包的路径
    private String authorName = "casia";//作者名字

    private String[] tablenames = {"user"};//要生成实体的表名集合，为空时全部生成


    private boolean f_cover = false;// 是否覆盖已存在的旧实体
    private boolean f_empty = false;// 是否注解不为null
    ...
    //数据库连接
//    private static final String URL ="jdbc:mysql://192.168.6.146:3306/sys_user?characterEncoding=utf-8&useSSL=false";
//    private static final String NAME = "web";
//    private static final String PASS = "web%2014";
    private static final String DRIVER ="com.mysql.cj.jdbc.Driver";


    private static final String URL ="jdbc:mysql://127.0.0.1:3306/test1?serverTimezone=UTC";
    private static final String NAME = "root";
    private static final String PASS = "zkhz123";
    /*
     * 构造函数
     */
...
//            sb.append("import com.fasterxml.jackson.annotation.JsonFormat;\r\n");
            ...
            if(f_empty){
                sb.append("import com.sun.istack.NotNull;\r\n");
            }
            if(f_Serializable){
        ...
        sb.append("\tprivate static final long serialVersionUID = -4294461808433313537L;\r\n ");
...
//                sb.append("\t@JsonFormat(shape= JsonFormat.Shape.STRING,pattern=\"yyyy-MM-dd HH:mm:ss\")\r\n");
                ...
                sb.append("\t//@JsonFormat(shape= JsonFormat.Shape.STRING,pattern=\"HH:mm:ss\")\r\n");
            }
